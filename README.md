...
<img src="https://github.com/Aswin480/Aswin480/raw/aaa2cb342b2a8fea87efb302d80d8ba7162a1264/WhatsAppVideo2025-10-26at17.03.41_c5bf0bcb-ezgif.com-optimize.gif" width="100%"/>
...
Production-grade LLM chatbot with multi-user concurrent session support and a real-time backend decision engine. Built for high throughput with scalable architecture.

- Multi-user session management
- Real-time response generation engine
- High-concurrency scalable API backend
...
Modular NLP pipeline built on Hugging Face Transformers for plug-and-play AI tasks with scalable backend orchestration and production-ready design.

- Named Entity Recognition (NER)
- Sentiment Analysis + Text Summarization
- Scalable backend orchestration layer
...
Real-time IDS combining signature-based and ML anomaly detection. Monitors live network traffic and classifies threats with minimal false-positive rates.

- Dual-mode threat classification engine
- Live network traffic monitoring
- Low false-positive rate ML model
...
<img src="https://github.com/Aswin480/Aswin480/raw/output/github-contribution-grid-snake.svg" width="100%"/>
